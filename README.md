...
#### Grant Terminal full-disk access and then launch it (probably DEPRECATED)
> [!NOTE]
> I think the following (about Full Disk Access for Terminal) can be removed, because the Hypervisor takes care of this automatically.
> 
