...
safe_source "${GMS_RESOURCE_INSTALLATION_SCRIPTS}/install_fira_code_nerd_font_systemwide.sh"
safe_source "${GMS_RESOURCE_INSTALLATION_SCRIPTS}/install_matrix_screensaver_systemwide.sh"
safe_source "${GMS_RESOURCE_INSTALLATION_SCRIPTS}/install_uh_oh_sound_systemwide.sh"
