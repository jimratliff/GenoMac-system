...
# Screensaver-related scripts should be placed in GenoMac-system/scripts/resource_installation
...
PREFS_SCREENSAVER_FUNCTIONS_DIR="${this_script_dir}/resource_installation"
