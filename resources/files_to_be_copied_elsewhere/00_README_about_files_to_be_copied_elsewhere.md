...
- `spawn`
  ...
  - `user-spawn-config.json`
    - This is a *template* for USER_CONFIGURER (a) to adapt/modify for their particular set of users and volumes and (b) manually copy to `GenoMac-private/spawn`.
